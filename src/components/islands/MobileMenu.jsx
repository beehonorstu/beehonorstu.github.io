                      ...
                      <li key={link.label}>
                        {link.children ? (
                          <div className="flex flex-col">
                            <div className={`flex items-center justify-between py-2 text-xl md:text-lg font-bold ${isLinkActive ? 'text-primary dark:text-blue-300' : 'text-foreground/80 dark:text-white'
                              }`}>
                              {link.label}
                            </div>
                                ...
                                return (
                                  <li key={child.href}>
                                    <a
                                      href={child.href}
                                      onClick={() => setIsOpen(false)}
                                      className={`py-2 text-lg md:text-base transition-colors flex items-center gap-3 ${isActive(child.href)
                          ...
                          <a
                            href={link.href}
                            onClick={() => setIsOpen(false)}
                            className={`flex items-center justify-between py-2 text-xl md:text-lg font-bold transition-colors ${isActive(link.href)
